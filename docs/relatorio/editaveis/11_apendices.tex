...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=1\textwidth]{Esquema_labirinto.png}
...
\begin{figure}[htbp]
  ...
  \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.8\textwidth]{editaveis/XaropinhoV2 Isomérica.jpg}
        \caption{Draft isomérica  modelo CAD da segunda iteração.}
        \label{fig:iso do micromouse}
    \end{figure}
  ...
  \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.8\textwidth]{editaveis/XaropinhoV2 Explodida.jpg}
        \caption{Vista Explodida  modelo CAD da segunda iteração.}
        \label{fig:iso do micromouse}
    \end{figure}

     \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.8\textwidth]{editaveis/XaropinhoV3 isomérica.jpg}
        \caption{Draft isomérica  modelo CAD da Terceira iteração.}
        \label{fig:iso do micromouse}
    \end{figure}
  ...
  \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.8\textwidth]{editaveis/XaropinhoV3 Explodida.jpg}
        \caption{Vista Explodida  modelo CAD da Terceira iteração.}
        \label{fig:iso do micromouse}
    \end{figure}
