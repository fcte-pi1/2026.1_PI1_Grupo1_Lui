...
extern void ff_inicializar(int larg, int alt, vector<pair<int,int>> meta);
extern void ff_parede(int x, int y, Direcao dir);
extern void ff_recalcular();
extern void ff_visitado(int x, int y);
